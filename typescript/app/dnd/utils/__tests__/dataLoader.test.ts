...
describe('dataLoader', () => {
  ...
  describe('loadHeroesFromDatabase', () => {
    ...
    it('should fall back to localStorage on network error', async () => {
      ...
      localStorageMock.setItem('dnd_loaded_classes', JSON.stringify(mockHeroes));
