...
describe('Battle Calculations', () => {
  describe('Attack Roll Calculation', () => {
    const createTestClass = (attackBonus: number, armorClass: number): DnDClass => ({
      name: 'Test Class',
      hitPoints: 50,
      maxHitPoints: 50,
      armorClass,
  ...
  describe('Damage Calculation', () => {
    const createTestClass = (damageDie: string): DnDClass => ({
      name: 'Test Class',
      hitPoints: 50,
      maxHitPoints: 50,
      armorClass: 15,
  ...
  describe('Defeat Conditions', () => {
    const createTestClass = (hitPoints: number, maxHitPoints: number): DnDClass => ({
      name: 'Test Class',
      hitPoints,
      maxHitPoints,
      armorClass: 15,
