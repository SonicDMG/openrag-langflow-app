...
- `typescript/app/dnd/server/storage.ts` - Server-side image storage
- `typescript/app/dnd/hooks/useBattleData.ts` - Data loading with URL normalization
- `typescript/app/dnd/components/card-parts/CardImage.tsx` - Image rendering component
