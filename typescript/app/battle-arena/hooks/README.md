# Battle Arena Hooks Organization

This directory contains all React hooks for the Battle Arena battle system, organized by domain.
...
- `battle arena/hooks/` (7 battle hooks) → `battle arena/hooks/battle/`
- `battle arena/components/hooks/` (5 UI hooks) → `battle arena/hooks/ui/`
- `battle arena/test/hooks/` remains separate for test-specific utilities
