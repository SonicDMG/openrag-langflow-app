/**
 * Utility functions for Battle Arena Test Page actions
 ...
 */
export function calculateHighDamage(targetClass: Character): number {
 ...
 */
export function calculateFullHeal(playerClass: Character): number {
 ...
 */
export function getMonsterLookupName(monster: Character & { klass?: string }): string {
 ...
 */
export function createTestEntity<T extends Character & { monsterId?: string; imageUrl?: string }>(
  entity: T
): T {
  return {
    ...entity,
