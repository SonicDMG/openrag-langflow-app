...
function determineCharacterType(playerClass: Character, editType?: 'hero' | 'monster') {
...
function extractMonsterIdFromSources(playerClass: Character, monsterImageUrl?: string): string | null {
...
export function CharacterCardZoom({
  ...
  const handleEdit = () => {
    ...
    router.push(`/battle-arena/unified-character-creator?id=${encodeURIComponent(characterId)}&type=${determinedEditType}`);
  };
