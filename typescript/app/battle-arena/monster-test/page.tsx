...
export default function MonsterTestPage() {
  ...
  // Create Character object for the selected monster
  const selectedMonsterClass: Character | null = selectedMonsterId ? (() => {
    const monster = createdMonsters.find(m => m.monsterId === selectedMonsterId);
    if (!monster) {
                ...
                <div className="space-y-3 pt-3 border-t border-amber-700">
                  <div>
                    ...
                    <p className="text-xs text-amber-300 mt-1">
                      Choose which Battle Arena class or monster type this created monster represents.
                    </p>
                  </div>
